...
def main(page: ft.Page):
    ...
    contenedor_acciones_empleados = ft.Column()
    ...
    def acciones_empleados(action):
        ...
        if action == "ver":
            result = ver_empleados(conexion)
            mostrar_mensaje(result)
        elif action == "insertar":
            idEmp = ft.TextField(label="ID Empleado")
            ...
            contenedor_acciones_empleados.controls.extend([
                    idEmp, nombre, numero, puesto,
                    ft.ElevatedButton("Insertar", on_click=insertar_click)
                ])
    ...
    def tab_empleados():
            return ft.Column([
                ...
                ft.Row([
                    ft.ElevatedButton("Ver", on_click=lambda e: acciones_empleados("ver")),
                    ft.ElevatedButton("Insertar", on_click=lambda e: acciones_empleados("insertar")),
                    ft.ElevatedButton("Actualizar", on_click=lambda e: acciones_empleados("actualizar")),
                    ft.ElevatedButton("Eliminar", on_click=lambda e: acciones_empleados("eliminar")),
                ], alignment=ft.MainAxisAlignment.CENTER),
    ...
    tabs = ft.Tabs(
        ...
        tabs=[
            ...
            ft.Tab(text="Empleados", content=tab_empleados()),
        ],
        expand=True
    )
